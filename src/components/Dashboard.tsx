          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              <select
                ...
                className="bg-white/80 backdrop-blur-sm border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium shadow-sm hover:shadow-md transition-all duration-200 focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              >
              ...
              <button
                onClick={copyAddress}
                className="flex items-center space-x-3 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-xl px-4 py-3 text-slate-600 hover:text-slate-900 transition-all duration-200 shadow-sm hover:shadow-md"
              >
                <span className="text-sm font-mono font-medium">{walletAddress}</span>
